...
1. **Cambio en la base de datos al subir un anuncio nuevo (archivo gif)**
 
  ![**Publicar anuncio**](https://github.com/Nitro1000/UyA/blob/master/Practica7/img/Publicar-anuncio.gif)
    
2. **Cambio en la base de datos al modificar una anuncio (archivo gif)**
  
  ![**Modificar anuncio**](https://github.com/Nitro1000/UyA/blob/master/Practica7/img/Modificar-anuncio.gif)
  
3. **Ir a la página  [subir anuncio](https://nitro1000.github.io/UyA/Practica7/NuevoAnuncio.html) modificar la base de datos o desde la página principal en la barra de navegación**
